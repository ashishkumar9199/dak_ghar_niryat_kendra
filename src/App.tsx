...
function AppContent() {
  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden bg-[#F8F9FA] text-gray-800 flex flex-col font-sans selection:bg-[#FFC107] selection:text-[#D42426]">
      ...
      <footer className="bg-gray-900 text-gray-400 border-t border-gray-800 text-[11px] flex-shrink-0">
        <div className="w-full max-w-[1440px] 2xl:max-w-[1600px] mx-auto px-3 sm:px-5 md:px-6 lg:px-8 xl:px-10 py-6 sm:py-8">
